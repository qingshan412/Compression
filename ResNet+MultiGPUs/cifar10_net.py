...
MOVING_AVERAGE_DECAY = 0.0001     # The decay to use for the moving average.
...
def inference_resnet_20(images, n2=3):
  """Build the CIFAR-10 resnet-20 model.

  Args:
    images: Images returned from build_input().

  Returns:
    Logits.
  
  def res_net_model(features, labels, n2=3, mode):
  ...
  groups = [BottleneckGroup(n2, 16),  BottleneckGroup(n2, 32),
            BottleneckGroup(n2, 64)]

  x = images#features[X_FEATURE]
